...
public class FrmBusquedaProducto extends javax.swing.JDialog {
    ...
    public void setDatos(ProductoManager productoMgr, ClienteManager clienteMgr) {
        ...
        for (int i = 0; i < productoMgr.numeroProductos(); i++) {
            if (txtCriterio.getText().equals("")) {
                ...
                if (rbtDescripcion.isSelected()) {
                    if (clienteMgr.getClientes()[i].getNombres().startsWith(txtCriterio.getText())) {
                        registro[0] = productoMgr.getProductos()[i].getIdProducto();
                        registro[1] = productoMgr.getProductos()[i].getDescripcion();
                        miTabla.addRow(registro);
                    }
                    ...
                    if (clienteMgr.getClientes()[i].getIdCliente().startsWith(txtCriterio.getText())) {
                        registro[0] = productoMgr.getProductos()[i].getIdProducto();
                        registro[1] = productoMgr.getProductos()[i].getDescripcion();
                        miTabla.addRow(registro);
                    }
